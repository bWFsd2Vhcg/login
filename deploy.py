...
os.system(f'echo \'[Unit]\' > {service_file}')
os.system(f'echo \'Description=Gunicorn instance to serve login app\' >> {service_file}')
os.system(f'echo \'After=network.target\' >> {service_file}')
os.system(f'echo \'\' >> {service_file}')
os.system(f'echo \'[Service]\' >> {service_file}')
os.system(f'echo \'User={os.getlogin()}\' >> {service_file}')
os.system(f'echo \'Group=www-data\' >> {service_file}')
os.system(f'echo \'WorkingDirectory={os.getcwd()}\' >> {service_file}')
os.system(f'echo \'Environment="PATH={os.path.join(os.getcwd(), "venv/bin")}"\' >> {service_file}')
...
os.system(f'echo \'\' >> {service_file}')
os.system(f'echo \'[Install]\' >> {service_file}')
os.system(f'echo \'WantedBy=multi-user.target\' >> {service_file}')
...
os.system(f'echo \'server {{\' > {nginx_file}')
os.system(f'echo \'    listen 80;\' >> {nginx_file}')
os.system(f'echo \'    server_name {domain_name or "_"};\' >> {nginx_file}')
os.system(f'echo \'    \' >> {nginx_file}')
os.system(f'echo \'    location / {{\' >> {nginx_file}')
os.system(f'echo \'        include proxy_params;\' >> {nginx_file}')
os.system(f'echo \'        proxy_pass http://unix:{os.path.join(os.getcwd(), "login_app.sock")};\' >> {nginx_file}')
os.system(f'echo \'    }}\' >> {nginx_file}')
os.system(f'echo \'}}\' >> {nginx_file}')
